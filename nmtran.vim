...
syntax match  NMFloat  "[-+]\=\<\d[[:digit:]_]*[eE][\-+]\=\d\+"
syntax match  NMFloat  "[-+]\=\<\d[[:digit:]_]*\.[[:digit:]_]*\([eE][\-+]\=\d\+\)\="
syntax match  NMFloat  "[-+]\=\<\.[[:digit:]_]\+\([eE][\-+]\=\d\+\)\="

" Comments:
syntax region NMComment start=";.*$" end="" contains=NMTodo

syntax sync ccomment NMComment

" Todo.
syntax keyword NMTodo TODO FIXME XXX DEBUG NOTE contained
...
if version >= 508 || !exists("did_c_syn_inits")
  ...
  highlight NMComment             ctermfg=8
  highlight NMOperator            ctermfg=208
  HiLink NMSpecial                Special
  highlight NMKeyword             ctermfg=14
  highlight NMControlRecordOption ctermfg=14
  HiLink NMNumber                 Number
  HiLink NMFloat                  Float
  highlight NMControlRecord       ctermfg=10
  highlight NMdrop                ctermfg=196
